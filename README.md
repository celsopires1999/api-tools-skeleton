Esse repositório foi usado para acompanhamento da aula do módulo Comunicação.
Após gerar a imagem com o Dockerfile, usar o comando abaixo:
docker run -it -p 8000:80 -v $(pwd):/var/www nome-da-imagem
